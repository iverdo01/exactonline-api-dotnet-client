...
Public Class [Services]
	...
	Public Sub New()
        ...
        Services.Add(GetType(PurchaseInvoice.PurchaseInvoice).FullName, "purchase/PurchaseInvoices")
        Services.Add(GetType(PurchaseInvoice.PurchaseInvoiceLine).FullName, "purchase/PurchaseInvoiceLines")
